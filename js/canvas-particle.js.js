var CanvasParticle = (function(){
	...
	function canvasInit(canvasConfig){
		...
		var body = document.getElementById("banner");
		...
		var canvas = {
			...
			config: {
				...
				stroke: canvasConfig.stroke || "52,336,250",
		...
		canvas.element.style = "position: absolute; top: 0; left: 0; z-index: -1;width:100%;height:100%";
	...
	function canvasSize(canvas){
		...
		// 鑾峰彇鐗瑰畾div鐨勫楂�
		var width = document.getElementById("banner").style.width;
		var height = document.getElementById("banner").style.height;
